    ...
    for item in items:
        ...
        sections.append(
            ...
            f"{_section('Fundamental KPIs', [
                ...
                ('Dividend years paid', fundamentals.get('dividend_years_paid')),
                ('Consecutive dividend years', fundamentals.get('consecutive_dividend_years')),
                ('5-year dividend CAGR', fundamentals.get('dividend_cagr_5y')),
                ('Latest dividend year', fundamentals.get('latest_dividend_year')),
                ...
                ('Return on assets', fundamentals.get('return_on_assets')),
                ('Profit margins', fundamentals.get('profit_margins')),
                ('Operating margins', fundamentals.get('operating_margins')),
                ...
                ('Free cashflow yield', fundamentals.get('free_cashflow_yield')),
                ('Price to book', fundamentals.get('price_to_book')),
                ('Enterprise value / EBITDA', fundamentals.get('enterprise_to_ebitda')),
                ('PEG ratio', fundamentals.get('peg_ratio')),
                ('Payout ratio', fundamentals.get('payout_ratio')),
                ('Funds from operations', fundamentals.get('funds_from_operations')),
                ('Funds from operations yield', fundamentals.get('funds_from_operations_yield')),
